...
class WITCHPT_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UWitchPTIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UWitchPTIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UWitchPTIndicatorManagerComponent> ManagerPtr;
