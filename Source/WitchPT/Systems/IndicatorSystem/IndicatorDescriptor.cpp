...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UWitchPTIndicatorManagerComponent* InManager)
{
...
{
	if (UWitchPTIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
